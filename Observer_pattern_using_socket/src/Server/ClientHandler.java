...
public class ClientHandler extends Thread implements IObserver{
    public String username;
    public Socket socket;
    public DataOutputStream dataOutputStream;
    public DataInputStream dataInputStream;
    public IObservable server;
    public String message;

    public ClientHandler(Socket socket, IObservable server) throws Exception{
        this.server=server;
        this.socket=socket;
